...
<body class="bg-white min-h-screen flex">
    ...
    <div class="hidden md:flex w-1/2 bg-gray-100 items-center justify-center">
        <img src="{{ url('img/tugu_jogja_header.png') }}" 
             alt="Login Image" class="object-cover h-full w-full">
    </div>
    ...
    <div class="flex w-full md:w-1/2 items-center justify-center p-6">
        <div class="w-full max-w-md">
            ...
            <div class="text-left mb-12">
                ...
                <h1 class="text-6xl sm:text-5xl font-extrabold text-gray-900 leading-tight mt-2">Selamat Datang</h1>
            </div>
            ...
            <form action="{{ route('handle-login') }}" method="POST" class="space-y-6">
                ...
                <div>
                    <input type="email" id="email" name="email" 
                        class="w-full border-b border-gray-300 py-2 focus:outline-none focus:border-gray-800 transition"
                        placeholder="Email">
                </div>
                ...
                <div class="relative">
                    ...
                    <span id="togglePassword" class="absolute right-2 text-gray-500 cursor-pointer">
